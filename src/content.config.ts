...
// Compartido entre `projects` (es) y `projectsEn` (en): mismo shape para
// ambos locales, solo cambia la carpeta de origen del loader.
...
// Colección en inglés: mismos nombres de archivo que `projects` (mismo
// `id` por proyecto en ambos locales), así los hrefs y el join contra
// `projectSlugs` en experience.ts/experience.en.ts funcionan sin cambios.
